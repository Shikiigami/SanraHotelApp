...
<div class="grid grid-cols-1 gap-6">
  ...
  <div class="flex items-center justify-between text-white bg-orange-400 rounded-lg shadow p-6">
    <div>
      <p class="text-2xl font-bold">Checkins</p>
      <h2 class="text-lg">Manage Guest Checkins</h2>
    </div>
...
<div class="w-full overflow-x-auto">
  ...
  <table id="checkinTable" class="text-sm w-full border border-gray-300 divide-y divide-gray-200">
      <thead class="bg-orange-100 text-orange-700">
        <tr>
          <th class="px-4 py-2 text-left font-medium">ReserveId</th>
          ...
          <th class="px-4 py-2 text-left font-medium">Pay Stat.</th>
          <th class="px-4 py-2 text-left font-medium">Pay. Met</th>
          <th class="px-4 py-2 text-left font-medium">Ref</th>
          <th class="px-4 py-2 text-left font-medium">In Charge</th>
...
<script src="{{ asset('assets/js/checkin.js')}}?v={{ time() }}"></script>
